...
public:
    ...
    //   테스트 전용 주입 메서드. nullptr 전달 시 프로덕션 싱글톤으로 복원
    ...
    //   테스트 편의 Setter (프로덕션에서는 LoadConfig() 사용)
